const VideoHero = () => {
  return (
    <div className="">
      ...
      >
        <source
          src="https://res.cloudinary.com/dg6y2dtpl/video/upload/v1666185545/production_ID_4761426_rsapo9.mp4"
          type="video/mp4"
        />
      </video>
      <div className="flex justify-center items-center text-white h-screen">
        <div className="flex-col">
          <span className="text-['Manrope'] text-[44px] md:text-8xl ">
            Dare to be great.
          </span>
          <div className=" flex justify-center items-center gap-5 md:gap-4 mt-10">
            <button className=" rounded-full text-['Manrope'] text-base bg-white text-black h-12 px-7 font-semibold">
              Get Started
            </button>
